    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <LoadingButton
          ...
          className={`w-full ${operationToEdit ? 'bg-[#ffcc00]' : 'bg-[#03D791]'} text-[#002110] font-black uppercase tracking-[0.4em] py-5 rounded-2xl text-[11px] hover:scale-[1.02] active:scale-95 transition-all shadow-lg italic pr-[0.4em]`}
        >
