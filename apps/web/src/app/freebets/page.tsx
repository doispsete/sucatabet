      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-4">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-[10px] font-black uppercase tracking-[0.5em] text-[#03D791] italic pr-[0.5em]">Hub de Freebets</h2>
          </div>
      ...
      <div className="space-y-8 pt-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2">
            ...
            <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase pr-[0.1em]">Histórico de <span className="text-[#03D791]">Operações</span></h3>
          </div>
