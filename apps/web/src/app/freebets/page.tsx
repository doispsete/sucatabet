      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-4">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-[10px] font-black uppercase tracking-[0.5em] text-[#03D791] italic pr-[0.5em] w-full text-center md:text-left">Hub de Freebets</h2>
          </div>
      ...
      <div className="space-y-8 pt-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2">
            ...
            <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase pr-[0.1em] text-center md:text-left">Histórico de <span className="text-[#03D791]">Operações</span></h3>
          </div>
        ...
        <form onSubmit={handleCreateFreebet} className="space-y-6">
          ...
          <div className="pt-4">
            <LoadingButton
              ...
              className="w-full bg-[#03d791] text-black font-black uppercase tracking-[0.4em] italic py-6 rounded-[25px] text-[10px] hover:shadow-[0_20px_40px_rgba(3,215,145,0.2)] hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-20 pr-[0.4em]"
            >
              Cadastrar freebet
            </LoadingButton>
          </div>
